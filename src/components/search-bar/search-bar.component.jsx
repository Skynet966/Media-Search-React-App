...
export const SearchBar = props =>(
    <div className="input-group shadow-sm bg-white rounded p-3 mx-auto my-5">
        <input type="Search" className="form-control shadow-none bg-light" onKeyDown={e=>e.key==='Enter'?props.handleChange(e):''} name="search_text" placeholder="Search here..." aria-describedby="searchbar"/>
